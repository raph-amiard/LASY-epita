...
PDFs/4_introduction_to_rust_2_TP.pdf: src/4_introduction_to_rust_2_TP.md
	pandoc src/4_introduction_to_rust_2_TP.md -o PDFs/4_introduction_to_rust_2_TP.pdf
